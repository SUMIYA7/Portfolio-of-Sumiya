...
import CV from "../../assets/Mosa. Sumiya Akter's Resume.pdf";
const Data = () => {
    return (
      <div className="home__data">
        ...
        <h3 className="home__subtitle2 animate-charcter">
          Full Stack Web Developer -MERN
        </h3>
        <p className="home__description animate-charcter2">
        a passionate and dedicated full stack web developer specializing in the MERN stack. Currently in my final year of BSc in Computer Science and Engineering at BAIUST, I am excited to embark on an exciting career in the world of web development.
        </p>
